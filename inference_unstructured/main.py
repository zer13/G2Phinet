...
def main(idseeds, seeds, num_types, num_latent, num_epochs, plot_itvl, savefigs, epochs, choice_numx):
    ...
    for test_set in [1,2,3,4,5]:
        ...
        for isample in range(num_types):
            is_correct, gtp_pred, latent, loss, data_save = inference_single(idseeds,test_set,isample,seeds,num_types,num_latent, num_epochs, plot_itvl, savefigs, epochs, choice_numx, data_loc)
    ...
    io.savemat('./Inference/result-{}.mat'.format(idseeds),{'infer_gtp_pred':infer_gtp_pred,'infer_numcorrect':infer_numcorrect,'infer_latent':infer_latent,'infer_loss':infer_loss})
...
main(idseeds, seeds, num_types, num_latent, num_epochs, plot_itvl, savefigs, epochs, choice_numx)